...
## <a name="chapter-1---the-azure-portal-creating-the-azure-storage-account"></a><span data-ttu-id="1b6d5-146">第1章-Azure 入口網站: 建立 Azure 儲存體帳戶</span><span class="sxs-lookup"><span data-stu-id="1b6d5-146">Chapter 1 - The Azure Portal: creating the Azure Storage Account</span></span>
...
4.  <span data-ttu-id="1b6d5-155">在 [**建立儲存體帳戶**] 索引標籤中:</span><span class="sxs-lookup"><span data-stu-id="1b6d5-155">In the **Create storage account** tab:</span></span>
    ...
    6.  <span data-ttu-id="1b6d5-161">將 [**需要安全傳輸**] 保留為 [**停用**]。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-161">Leave **Secure transfer required** as **Disabled**.</span></span>
...
13. <span data-ttu-id="1b6d5-212">您會注意到已成功上傳您的影片。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-212">You will notice that your video has been successfully uploaded.</span></span> <span data-ttu-id="1b6d5-213">按一下 [開啟]。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-213">Click on it.</span></span>
...
<span data-ttu-id="1b6d5-269">以下是使用混合現實進行開發的一般設定, 因此是適用于其他專案的絕佳範本。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-269">The following is a typical set up for developing with the Mixed Reality, and as such, is a good template for other projects.</span></span>
...
5.  <span data-ttu-id="1b6d5-283">也請確定:</span><span class="sxs-lookup"><span data-stu-id="1b6d5-283">Also make sure that:</span></span>
    ...
    6.  <span data-ttu-id="1b6d5-289">現在請不要擔心設定**場景**, 因為您稍後會進行設定。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-289">Do not worry about setting up **Scenes** right now, as you will set these up later.</span></span>
...
## <a name="chapter-4---importing-the-insideoutsphere-unity-package"></a><span data-ttu-id="1b6d5-306">第4章-匯入 InsideOutSphere Unity 封裝</span><span class="sxs-lookup"><span data-stu-id="1b6d5-306">Chapter 4 - Importing the InsideOutSphere Unity package</span></span>
...
9.  <span data-ttu-id="1b6d5-389">在**Start ()** 方法後面, 插入**連結 playvideo ()** *IEnumerator*方法, 這將用來順暢地啟動影片 (因此不會出現任何斷斷續續)。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-389">Following the **Start()** method, insert the **PlayVideo()** *IEnumerator* method, which will be used to start videos seamlessly (so no stutter is seen).</span></span>
...
14. <span data-ttu-id="1b6d5-399">將 [ **InsideOutSphere** ] 物件從 [階層]**面板**拖曳至 [**球體**] 位置, 如下圖所示。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-399">Drag the **InsideOutSphere** object from the **Hierarchy Panel** to the **Sphere** slot, as shown in the image below.</span></span>
...
5.  <span data-ttu-id="1b6d5-426">回到 Unity, 開啟您的**幕後**資料夾, 然後以滑鼠左鍵按一下您的**VideoScene1**檔案。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-426">Back in Unity, open your **Scenes** folder, and left-click your **VideoScene1** file.</span></span> <span data-ttu-id="1b6d5-427">使用您的鍵盤, 然後按下**Ctrl + D** , 將會複製該場景</span><span class="sxs-lookup"><span data-stu-id="1b6d5-427">Use your keyboard, and press **Ctrl + D** you will duplicate that scene</span></span>
...
9.  <span data-ttu-id="1b6d5-436">當第二個場景開啟時, 按一下**InsideOutSphere**的 [ **GazeButton** ] 子物件, 並設定其轉換, 如下所示:</span><span class="sxs-lookup"><span data-stu-id="1b6d5-436">With the second scene open, click on the **GazeButton** child object of the **InsideOutSphere**, and set its Transform as follows:</span></span>
    ...
    |            |    <span data-ttu-id="1b6d5-441">轉換-旋轉</span><span class="sxs-lookup"><span data-stu-id="1b6d5-441">TRANSFORM - ROTATION</span></span>   |           |
    | :---------:| :-----------------------: | :--------:|
    |   <span data-ttu-id="1b6d5-442">**X** 0</span><span class="sxs-lookup"><span data-stu-id="1b6d5-442">**X** 0</span></span>  |          <span data-ttu-id="1b6d5-443">**Y** 0</span><span class="sxs-lookup"><span data-stu-id="1b6d5-443">**Y** 0</span></span>          |  <span data-ttu-id="1b6d5-444">**Z** 0</span><span class="sxs-lookup"><span data-stu-id="1b6d5-444">**Z** 0</span></span>  |

    |            |     <span data-ttu-id="1b6d5-445">轉換-調整規模</span><span class="sxs-lookup"><span data-stu-id="1b6d5-445">TRANSFORM - SCALE</span></span>     |           |
    | :---------:| :-----------------------: | :--------:|
    |  <span data-ttu-id="1b6d5-446">**X** 1</span><span class="sxs-lookup"><span data-stu-id="1b6d5-446">**X** 1</span></span>   |          <span data-ttu-id="1b6d5-447">**Y** 1</span><span class="sxs-lookup"><span data-stu-id="1b6d5-447">**Y** 1</span></span>          |  <span data-ttu-id="1b6d5-448">**Z** 1</span><span class="sxs-lookup"><span data-stu-id="1b6d5-448">**Z** 1</span></span>  |

10. <span data-ttu-id="1b6d5-449">在仍選取**GazeButton**子系的情況下, 查看 [**檢查**] 和 [**網格] 篩選準則**。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-449">With the **GazeButton** child still selected, look at the **Inspector** and at the **Mesh Filter**.</span></span> <span data-ttu-id="1b6d5-450">按一下 [**網格**參考] 欄位旁的小目標:</span><span class="sxs-lookup"><span data-stu-id="1b6d5-450">Click the little target next to the **Mesh** reference field:</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-51.png)

11. <span data-ttu-id="1b6d5-452">[**選取網格**] 快顯視窗隨即出現。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-452">A **Select Mesh** popup window will appear.</span></span> <span data-ttu-id="1b6d5-453">按兩下**資產**清單中的 [ **Cube**網格]。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-453">Double click the **Cube** mesh from the list of **Assets**.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-52.png)

12. <span data-ttu-id="1b6d5-455">**網格篩選器**將會更新, 現在是一個**Cube**。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-455">The **Mesh Filter** will update, and now be a **Cube**.</span></span> <span data-ttu-id="1b6d5-456">現在, 按一下 [**球體碰撞**件] 旁的**齒輪**圖示, 然後按一下 [**移除元件**], 以刪除此物件中的碰撞。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-456">Now, click the **Gear** icon next to **Sphere Collider** and click **Remove Component**, to delete the collider from this object.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-53.png)

13. <span data-ttu-id="1b6d5-458">在仍選取**GazeButton**的情況下, 按一下偵測**器**底部的 [**新增元件**] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-458">With the **GazeButton** still selected, click the **Add Component** button at the bottom of the **Inspector**.</span></span> <span data-ttu-id="1b6d5-459">在 [搜尋] 欄位中，輸入**方塊**，和**方塊 Collider**會是一個選項，按一下該選項，以新增**方塊 Collider**至您**GazeButton**物件.</span><span class="sxs-lookup"><span data-stu-id="1b6d5-459">In the search field, type **box**, and **Box Collider** will be an option -- click that, to add a **Box Collider** to your **GazeButton** object.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-54.png)

14. <span data-ttu-id="1b6d5-461">**GazeButton**現在已部分更新, 看起來會不同, 不過, 您現在會建立新的資料, 讓它看起來完全不同, 而且比第一個場景中的物件更容易辨識為不同的物件。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-461">The **GazeButton** is now partially updated, to look different, however, you will now create a new **Material**, so that it looks completely different, and is easier to recognize as a different object, than the object in the first scene.</span></span>

15. <span data-ttu-id="1b6d5-462">在 [**專案] 面板**中, 流覽至您的 [**材質**] 資料夾。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-462">Navigate to your **Materials** folder, within the **Project Panel**.</span></span> <span data-ttu-id="1b6d5-463">複製**ButtonMaterial**材質 (在鍵盤上按**Ctrl**  +  **D** , 或以滑鼠右鍵按一下**材質**, 然後從 [**編輯**檔案] 功能表選項選取 [**複製**])。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-463">Duplicate the **ButtonMaterial** Material (press **Ctrl** + **D** on the keyboard, or left-click the **Material**, then from the **Edit** file menu option, select **Duplicate**).</span></span>

    <span data-ttu-id="1b6d5-464">![第7章--設定兩個 unity](images/AzureLabs-Lab6-55.png)
    場景![第7章--設定兩個 unity 場景](images/AzureLabs-Lab6-56.png)</span><span class="sxs-lookup"><span data-stu-id="1b6d5-464">![Chapter 7 -- Setup the two Unity Scenes](images/AzureLabs-Lab6-55.png)
![Chapter 7 -- Setup the two Unity Scenes](images/AzureLabs-Lab6-56.png)</span></span>

16. <span data-ttu-id="1b6d5-465">選取新的**ButtonMaterial**材質 (名為**ButtonMaterial 1**), 然後在偵測**器**中, 按一下 [ **Albedo**色彩] 視窗。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-465">Select the new **ButtonMaterial** Material (here named **ButtonMaterial 1**), and within the **Inspector**, click the **Albedo** color window.</span></span> <span data-ttu-id="1b6d5-466">隨即會出現一個快顯視窗, 您可以在其中選取另一個色彩 (選擇您喜歡的方式), 然後關閉快顯視窗。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-466">A popup will appear, where you can select another color (choose whichever you like), then close the popup.</span></span> <span data-ttu-id="1b6d5-467">此材質會是它自己的實例, 與原始的不同。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-467">The Material will be its own instance, and different to the original.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-57.png)

17. <span data-ttu-id="1b6d5-469">將新的資料拖曳到**GazeButton**子系上, 以立即完整更新其外觀, 讓它可以輕鬆地從第一個場景按鈕來區分。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-469">Drag the new **Material** onto the **GazeButton** child, to now completely update its look, so that it is easily distinguishable from the first scenes button.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-58.png)

18. <span data-ttu-id="1b6d5-471">此時, 您可以在建立 UWP 專案之前, 先在編輯器中測試專案。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-471">At this point you can test the project in the Editor before building the UWP project.</span></span>

    -  <span data-ttu-id="1b6d5-472">按下**編輯器**中的 [**播放**] 按鈕, 然後戴頭戴式裝置。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-472">Press the **Play** button in the **Editor** and wear your headset.</span></span>

        ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-59.png)

19. <span data-ttu-id="1b6d5-474">查看兩個**GazeButton**物件, 以在第一和第二部影片之間切換。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-474">Look at the two **GazeButton** objects to switch between the first and second video.</span></span>

## <a name="chapter-8---build-the-uwp-solution"></a><span data-ttu-id="1b6d5-475">第8章-建立 UWP 解決方案</span><span class="sxs-lookup"><span data-stu-id="1b6d5-475">Chapter 8 - Build the UWP Solution</span></span>

<span data-ttu-id="1b6d5-476">一旦確定編輯器沒有任何錯誤, 您就可以開始建立。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-476">Once you have ensured that the editor has no errors, you are ready to Build.</span></span>

<span data-ttu-id="1b6d5-477">若要建立:</span><span class="sxs-lookup"><span data-stu-id="1b6d5-477">To Build:</span></span>

1.  <span data-ttu-id="1b6d5-478">按一下 檔案 **> 儲存** 來儲存目前的場景。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-478">Save the current scene by clicking on **File > Save**.</span></span>

2.  <span data-ttu-id="1b6d5-479">勾選名為 [ **Unity C\# Projects** ] 的方塊 (這很重要, 因為它可讓您在組建完成後編輯類別)。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-479">Check the box called **Unity C\# Projects** (this is important because it will allow you to edit the classes after build is completed).</span></span>

3.  <span data-ttu-id="1b6d5-480">移至 [檔案] **> [組建設定**], 按一下 [**組建**]。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-480">Go to **File > Build Settings**, click on **Build**.</span></span>

4.  <span data-ttu-id="1b6d5-481">系統會提示您選取要 buildthe 解決方案的資料夾。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-481">You will be prompted to select the folder where you want to buildthe Solution.</span></span>

5.  <span data-ttu-id="1b6d5-482">建立**組建**資料夾, 並在該資料夾內建立另一個資料夾, 並使用您選擇的適當名稱。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-482">Create a **BUILDS** folder and within that folder create another folder with an appropriate name of your choice.</span></span>

6.  <span data-ttu-id="1b6d5-483">按一下您的新資料夾, 然後按一下 [**選取資料夾**], 選擇該資料夾, 在該位置開始組建。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-483">Click your new folder and then click **Select Folder**, so to choose that folder, to begin the build at that location.</span></span>

    <span data-ttu-id="1b6d5-484">![第8章--組建 uwp 解決方案](images/AzureLabs-Lab6-60.png)
     ![第8章--組建 uwp 解決方案](images/AzureLabs-Lab6-61.png)</span><span class="sxs-lookup"><span data-stu-id="1b6d5-484">![Chapter 8 -- Build the UWP Solution](images/AzureLabs-Lab6-60.png)
![Chapter 8 -- Build the UWP Solution](images/AzureLabs-Lab6-61.png)</span></span>

7.  <span data-ttu-id="1b6d5-485">Unity 完成建立 (可能需要一些時間) 之後, 它會在組建的位置開啟 [檔案**瀏覽器**] 視窗。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-485">Once Unity has finished building (it might take some time), it will open a **File Explorer** window at the location of your build.</span></span>

## <a name="chapter-9---deploy-on-local-machine"></a><span data-ttu-id="1b6d5-486">第9章-在本機電腦上部署</span><span class="sxs-lookup"><span data-stu-id="1b6d5-486">Chapter 9 - Deploy on Local Machine</span></span>

<span data-ttu-id="1b6d5-487">組建完成之後, [檔案**瀏覽器**] 視窗就會出現在組建的位置。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-487">Once the build has been completed, a **File Explorer** window will appear at the location of your build.</span></span> <span data-ttu-id="1b6d5-488">開啟您已命名並建立的資料夾, 然後按兩下該資料夾中的解決方案 (.sln) 檔案, 以 Visual Studio 2017 開啟您的解決方案。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-488">Open the Folder you named and built to, then double click on the solution (.sln) file within that folder, to open your solution with Visual Studio 2017.</span></span>

<span data-ttu-id="1b6d5-489">剩下的工作就是將您的應用程式部署到您的電腦 (或*本機電腦*)。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-489">The only thing left to do is deploy your app to your computer (or *Local Machine*).</span></span>

<span data-ttu-id="1b6d5-490">若要部署到本機電腦:</span><span class="sxs-lookup"><span data-stu-id="1b6d5-490">To deploy to Local Machine:</span></span>

1.  <span data-ttu-id="1b6d5-491">在**Visual Studio 2017**中, 開啟剛建立的方案檔。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-491">In **Visual Studio 2017**, open the solution file that has just been created.</span></span>

2.  <span data-ttu-id="1b6d5-492">在**解決方案平臺**中, 選取 [ **x86]、[本機電腦**]。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-492">In the **Solution Platform**, select **x86, Local Machine**.</span></span>

3.  <span data-ttu-id="1b6d5-493">在 [**解決方案**設定] 中, 選取 [ **Debug**]。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-493">In the **Solution Configuration** select **Debug**.</span></span>

    ![第9章--在本機電腦上部署](images/AzureLabs-Lab6-62.png)

4.  <span data-ttu-id="1b6d5-495">您現在必須將任何套件還原至您的解決方案。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-495">You will now need to restore any packages to your solution.</span></span> <span data-ttu-id="1b6d5-496">以滑鼠右鍵按一下您的**方案**, 然後按一下 [**還原解決方案的 NuGet 套件**...]</span><span class="sxs-lookup"><span data-stu-id="1b6d5-496">Right-click on your **Solution**, and click **Restore NuGet Packages for Solution...**</span></span>

    > [!NOTE] 
    > <span data-ttu-id="1b6d5-497">這是因為 Unity 所建立的套件必須設為目標, 才能與您的本機電腦參考搭配使用。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-497">This is done because the packages which Unity built need to be targeted to work with your local machines references.</span></span>

5.  <span data-ttu-id="1b6d5-498">移至 [**建立] 功能表**, 然後按一下 [**部署方案**], 將應用程式側載至您的電腦。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-498">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your machine.</span></span> <span data-ttu-id="1b6d5-499">Visual Studio 會先建立並部署您的應用程式。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-499">Visual Studio will first build and then deploy your application.</span></span>

6.  <span data-ttu-id="1b6d5-500">您的應用程式現在應該會出現在已安裝的應用程式清單中, 並準備好啟動。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-500">Your App should now appear in the list of installed apps, ready to be launched.</span></span>

    ![第9章--在本機電腦上部署](images/AzureLabs-Lab6-63.png)

<span data-ttu-id="1b6d5-502">當您執行 Mixed Reality 應用程式時, 您會在應用程式內使用的**InsideOutSphere**模型中。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-502">When you run the Mixed Reality application, you will you be within the **InsideOutSphere** model which you used within your app.</span></span> <span data-ttu-id="1b6d5-503">這個球體將是影片的串流目標位置, 提供內送影片的360度觀點 (這種觀點的 filmed)。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-503">This sphere will be where the video will be streamed to, providing a 360-degree view, of the incoming video (which was filmed for this kind of perspective).</span></span> <span data-ttu-id="1b6d5-504">如果影片需要幾秒鐘的時間才能載入, 您的應用程式會受限於可用的網際網路速度, 因為必須提取並下載影片, 才能串流至您的應用程式。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-504">Do not be surprised if the video takes a couple of seconds to load, your app is subject to your available Internet speed, as the video needs to be fetched and then downloaded, so to stream into your app.</span></span>
<span data-ttu-id="1b6d5-505">當您準備好時, 請撥雲見日紅色球體來變更場景並開啟第二個影片!</span><span class="sxs-lookup"><span data-stu-id="1b6d5-505">When you are ready, change scenes and open your second video, by gazing at the red sphere!</span></span> <span data-ttu-id="1b6d5-506">然後您可以隨意使用第二個場景中的藍色 cube!</span><span class="sxs-lookup"><span data-stu-id="1b6d5-506">Then feel free to go back, using the blue cube in the second scene!</span></span>

## <a name="your-finished-azure-media-service-application"></a><span data-ttu-id="1b6d5-507">您完成的 Azure 媒體服務應用程式</span><span class="sxs-lookup"><span data-stu-id="1b6d5-507">Your finished Azure Media Service application</span></span>
 
<span data-ttu-id="1b6d5-508">恭喜, 您建立了一個混合現實應用程式, 利用 Azure 媒體服務串流處理360影片。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-508">Congratulations, you built a mixed reality app that leverages the Azure Media Service to stream 360 videos.</span></span>

![實驗室結果](images/AzureLabs-Lab6-00.png)

![實驗室結果](images/AzureLabs-Lab6-01.png)

## <a name="bonus-exercises"></a><span data-ttu-id="1b6d5-511">額外練習</span><span class="sxs-lookup"><span data-stu-id="1b6d5-511">Bonus Exercises</span></span>

<span data-ttu-id="1b6d5-512">**練習1**</span><span class="sxs-lookup"><span data-stu-id="1b6d5-512">**Exercise 1**</span></span>

<span data-ttu-id="1b6d5-513">在本教學課程中, 您可以完全只使用單一場景來變更影片。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-513">It is entirely possible to only use a single scene to change videos within this tutorial.</span></span> <span data-ttu-id="1b6d5-514">試驗您的應用程式, 並使其進入單一場景!</span><span class="sxs-lookup"><span data-stu-id="1b6d5-514">Experiment with your application and make it into a single scene!</span></span> <span data-ttu-id="1b6d5-515">甚至可能將另一部影片新增至混合。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-515">Perhaps even add another video to the mix.</span></span>

<span data-ttu-id="1b6d5-516">**練習2**</span><span class="sxs-lookup"><span data-stu-id="1b6d5-516">**Exercise 2**</span></span>

<span data-ttu-id="1b6d5-517">使用 Azure 和 Unity 進行實驗, 並嘗試執行此功能, 讓應用程式根據網際網路連線的強度, 自動選取不同檔案大小的影片。</span><span class="sxs-lookup"><span data-stu-id="1b6d5-517">Experiment with Azure and Unity, and attempt to implement the ability for the app to automatically select a video with a different file size, depending on the strength of an Internet connection.</span></span>
