...
在本節中, 我們會說明如何使用連續的語音辨識, 在您的應用程式中啟用語音命令。 本逐步解說會使用[HolographicVoiceInput](http://go.microsoft.com/fwlink/p/?LinkId=844964)範例中的程式碼。 當範例正在執行時, 請說出其中一個已註冊的色彩命令的名稱, 以變更旋轉 cube 的色彩。
