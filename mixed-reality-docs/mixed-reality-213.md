...
# <a name="mr-input-213-motion-controllers"></a>MR 輸入 213:運動控制器
...
<td>MR 輸入 213:運動控制器</td><td style="text-align: center;"> </td><td style="text-align: center;"> ✔️</td>
</tr>
</table>
...
本教學課程會使用 **[混合實境工具組-Unity](https://github.com/Microsoft/MixedRealityToolkit-Unity)** 。 您可以在[此頁面](https://github.com/Microsoft/MixedRealityToolkit-Unity/releases)上找到版本。
...
* 您會在 [**場景**] 資料夾下找到兩個已完成的 Unity 場景。
    ...
    * **MixedReality213Advanced**:已完成具有多筆刷之先進設計的場景
...
* 混合現實工具組中有兩個相機 prefabs:
    ...
    * **MixedRealityCameraParent. prefab**:相機 + Teleportation + 界限
...
* 輸入 ' 灰階 ' 並選取**SkyboxGray**

(資產/AppPrefabs/支援/材質/SkyboxGray)
...
* 將 [ **ColorPickerWheel** prefab] 拖曳至 [階層] 面板。
...
[階層] 面板中不需要包含**BrushController** prefab。 不過, 若要簽出其子元件:
...
* 從 [ 階層] 面板中, 將 [ **ColorPickerWheel** ] 拖曳至 [偵測**器**] 面板中的 [ **ColorPicker** ] 欄位。
...
* 您會發現兩個 Unity sceens **MixedReality213**和**MixedReality213Advanced**。
    * **MixedReality213**:具有單一筆刷的已完成場景
    * **MixedReality213Advanced**:具有多重筆刷的已完成場景, 含有選取按鈕的按量範例
