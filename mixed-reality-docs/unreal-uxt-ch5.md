...
4.  將 WhiteKing 變數從 [我的藍圖] > [變數]  拖曳到 Simple Button Event Graph。 選擇 [取得 WhiteKing]  。 
...
6.  將 **SimpleButton** 拖曳到檢視區，並將其位置設定為 X = 50、Y = -25、Z = 10。 在 [預設值]  底下，將 WhiteKing 變數的值設定為 **WhiteKing**。
