...
2.  <span data-ttu-id="7c0f3-161">按一下 [**開始**使用] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-161">Click on the **Get Started** button.</span></span>
...
6.  <span data-ttu-id="7c0f3-170">右側會出現一個索引標籤, 它會提示您指定專案的某些欄位。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-170">A tab will appear on the right-hand side, which will prompt you to specify some fields for the project.</span></span>
    ...
    5. <span data-ttu-id="7c0f3-177">將*網域*設定為 **[一般**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-177">Set the *Domains* as **General**.</span></span>
...
4.  <span data-ttu-id="7c0f3-190">按一下頁面中央的 [**新增影像**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-190">Click on **Add Images** in the center of the page.</span></span>
...
11. <span data-ttu-id="7c0f3-205">當您按一下 [*預測 URL*] 之後, 請開啟 [*記事本*] 並複製並貼上**URL**和**預測金鑰**, 以便您稍後在程式碼中需要時加以取出。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-205">Once you have clicked on *Prediction URL*, open *Notepad*, and copy and paste the **URL** and the **Prediction-Key**, so that you can retrieve it when you need it later in the code.</span></span>
...
5.  <span data-ttu-id="7c0f3-222">仍在 檔案 **> 組建設定**, 並確認:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-222">While still in **File > Build Settings** and make sure that:</span></span>
    ...
    7.  <span data-ttu-id="7c0f3-236">[*組建設定*] 中的其餘設定, 現在應該保留為預設值。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-236">The remaining settings, in *Build Settings*, should be left as default for now.</span></span>
...
10.  <span data-ttu-id="7c0f3-250">儲存場景和專案 (**file > 儲存場景/檔案 > 儲存專案**)。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-250">Save your Scene and project (**FILE > SAVE SCENE / FILE > SAVE PROJECT**).</span></span>
...
2.  <span data-ttu-id="7c0f3-272">選取之後, 您就可以在 [偵測*器] 面板*中看到*主要攝影機*的所有元件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-272">Once selected, you will be able to see all the components of the *Main Camera* in the *Inspector Panel*.</span></span>
    ...
    3.  <span data-ttu-id="7c0f3-275">請確定**轉換位置**設定為**0, 0, 0**</span><span class="sxs-lookup"><span data-stu-id="7c0f3-275">Make sure the **Transform Position** is set to **0, 0, 0**</span></span>
...
<span data-ttu-id="7c0f3-290">若要建立此類別:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-290">To create this class:</span></span>
...
<span data-ttu-id="7c0f3-312">若要建立此類別:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-312">To create this class:</span></span>
...
1.  <span data-ttu-id="7c0f3-337">在 [**腳本**] 資料夾內部按一下滑鼠右鍵, 然後按一下 [**建立** >  **C\#腳本**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-337">Right-click inside the **Scripts** folder, then click **Create** > **C\# Script**.</span></span> <span data-ttu-id="7c0f3-338">呼叫腳本*CustomVisionTrainer*。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-338">Call the script *CustomVisionTrainer*.</span></span>
...
12. <span data-ttu-id="7c0f3-369">新增**DeletePreviousIteration ()** 方法。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-369">Add the **DeletePreviousIteration()** method.</span></span> <span data-ttu-id="7c0f3-370">這個方法會尋找並刪除先前的非預設反復專案:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-370">This method will find and delete the previous non-default iteration:</span></span>
...
13. <span data-ttu-id="7c0f3-371">在此類別中新增的最後一個方法是**GetImageAsByteArray ()** 方法, 用於 web 呼叫, 以將已捕獲的影像轉換成位元組陣列。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-371">The last method to add in this class is the **GetImageAsByteArray()** method, used on the web calls to convert the image captured into a byte array.</span></span>
...
14. <span data-ttu-id="7c0f3-372">請務必先將您的變更儲存在**Visual Studio**中, 然後再返回**Unity**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-372">Be sure to save your changes in **Visual Studio** before returning to **Unity**.</span></span>

## <a name="chapter-10---create-the-sceneorganiser-class"></a><span data-ttu-id="7c0f3-373">第10章-建立 SceneOrganiser 類別</span><span class="sxs-lookup"><span data-stu-id="7c0f3-373">Chapter 10 - Create the SceneOrganiser class</span></span>

<span data-ttu-id="7c0f3-374">此類別將會:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-374">This class will:</span></span>

-   <span data-ttu-id="7c0f3-375">建立要連接到主要攝影機的**游標**物件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-375">Create a **Cursor** object to attach to the Main Camera.</span></span>

-   <span data-ttu-id="7c0f3-376">建立將會在服務辨識出真實世界物件時顯示的**標籤**物件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-376">Create a **Label** object that will appear when the Service recognizes the real-world objects.</span></span>

-   <span data-ttu-id="7c0f3-377">藉由附加適當的元件來設定主要攝影機。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-377">Set up the Main Camera by attaching the appropriate components to it.</span></span>

-   <span data-ttu-id="7c0f3-378">在 [**分析] 模式**中, 會在執行時間時, 在適當的世界空間 (相對於主相機的位置) 中產生標籤, 並顯示從自訂視覺服務收到的資料。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-378">When in **Analysis Mode**, spawn the Labels at runtime, in the appropriate world space relative to the position of the Main Camera, and display the data received from the Custom Vision Service.</span></span>

-   <span data-ttu-id="7c0f3-379">在**定型模式**中, 會產生 UI, 以顯示定型程式的不同階段。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-379">When in **Training Mode**, spawn the UI that will display the different stages of the training process.</span></span>

<span data-ttu-id="7c0f3-380">若要建立此類別:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-380">To create this class:</span></span>

1.  <span data-ttu-id="7c0f3-381">在 [**腳本**] 資料夾內部按一下滑鼠右鍵, 然後按一下 [**建立** >  **C\#腳本**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-381">Right-click inside the **Scripts** folder, then click **Create** > **C\# Script**.</span></span> <span data-ttu-id="7c0f3-382">將腳本命名為*SceneOrganiser*。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-382">Name the script *SceneOrganiser*.</span></span>

2.  <span data-ttu-id="7c0f3-383">按兩下新的*SceneOrganiser*腳本, 以**Visual Studio**開啟它。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-383">Double-click on the new *SceneOrganiser* script to open it with **Visual Studio**.</span></span>

3.  <span data-ttu-id="7c0f3-384">您只需要一個命名空間, 並從*SceneOrganiser*類別的上方移除其他人:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-384">You will only need one namespace, remove the others from above the *SceneOrganiser* class:</span></span>

    ```csharp
    using UnityEngine;
    ```

4.  <span data-ttu-id="7c0f3-385">然後, 在*SceneOrganiser*類別內的**Start ()** 方法上方新增下列變數:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-385">Then add the following variables inside the *SceneOrganiser* class, above the **Start()** method:</span></span>
...
5.  <span data-ttu-id="7c0f3-386">刪除**Start ()** 和**Update ()** 方法。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-386">Delete the **Start()** and **Update()** methods.</span></span>

6.  <span data-ttu-id="7c0f3-387">在變數底下, 新增 [**喚醒 ()** ] 方法, 這會初始化類別並設定場景。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-387">Right underneath the variables, add the **Awake()** method, which will initialize the class and set up the scene.</span></span>
...
8. <span data-ttu-id="7c0f3-389">加入**SetCameraStatus ()** 方法, 它會處理提供相機狀態的文字網格所適用的訊息。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-389">Add the **SetCameraStatus()** method, which will handle messages intended for the text mesh providing the status of the camera.</span></span>
...
9. <span data-ttu-id="7c0f3-390">新增**PlaceAnalysisLabel ()** 和**SetTagsToLastLabel ()** 方法, 以產生自訂視覺服務中的資料, 並將其顯示到場景中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-390">Add the **PlaceAnalysisLabel()** and **SetTagsToLastLabel()** methods, which will spawn and display the data from the Custom Vision Service into the scene.</span></span>
...
10. <span data-ttu-id="7c0f3-391">最後, 加入**CreateTrainingUI ()** 方法, 這會在應用程式處於定型模式時, 產生 UI 以顯示定型進程的多個階段。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-391">Lastly, add the **CreateTrainingUI()** method, which will spawn the UI displaying the multiple stages of the training process when the application is in Training Mode.</span></span> <span data-ttu-id="7c0f3-392">這個方法也會駕馭, 以建立相機狀態物件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-392">This method will also be harnessed to create the camera status object.</span></span>
...
11. <span data-ttu-id="7c0f3-393">請務必先將您的變更儲存在**Visual Studio**中, 然後再返回**Unity**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-393">Be sure to save your changes in **Visual Studio** before returning to **Unity**.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="7c0f3-394">在繼續之前, 請開啟**CustomVisionAnalyser**類別, 然後在**AnalyseLastImageCaptured ()** 方法內,*取消*批註下列幾行:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-394">Before you continue, open the **CustomVisionAnalyser** class, and within the **AnalyseLastImageCaptured()** method, *uncomment* the following lines:</span></span>
>
> ```csharp
>   AnalysisObject analysisObject = new AnalysisObject();
>   analysisObject = JsonConvert.DeserializeObject<AnalysisObject>(jsonResponse);
...
## <a name="chapter-11---create-the-imagecapture-class"></a><span data-ttu-id="7c0f3-395">第11章-建立 ImageCapture 類別</span><span class="sxs-lookup"><span data-stu-id="7c0f3-395">Chapter 11 - Create the ImageCapture class</span></span>

<span data-ttu-id="7c0f3-396">下一個您即將建立的類別是*ImageCapture*類別。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-396">The next class you are going to create is the *ImageCapture* class.</span></span>

<span data-ttu-id="7c0f3-397">此類別負責:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-397">This class is responsible for:</span></span>

-   <span data-ttu-id="7c0f3-398">使用 HoloLens 攝影機來捕獲影像, 並將其儲存在*應用程式*資料夾中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-398">Capturing an image using the HoloLens camera and storing it in the *App* Folder.</span></span>

-   <span data-ttu-id="7c0f3-399">處理使用者的點擊手勢。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-399">Handling Tap gestures from the user.</span></span>

-   <span data-ttu-id="7c0f3-400">維護*列舉*值, 以決定應用程式是否會在*分析*模式或*定型*模式下執行。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-400">Maintaining the *Enum* value that determines if the application will run in *Analysis* mode or *Training* Mode.</span></span>

<span data-ttu-id="7c0f3-401">若要建立此類別:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-401">To create this class:</span></span>

1.  <span data-ttu-id="7c0f3-402">移至您先前建立的**腳本**資料夾。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-402">Go to the **Scripts** folder you created previously.</span></span>

2.  <span data-ttu-id="7c0f3-403">在資料夾內部按一下滑鼠右鍵, 然後按一下 [**建立 >\# C 腳本**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-403">Right-click inside the folder, then click **Create > C\# Script**.</span></span> <span data-ttu-id="7c0f3-404">將腳本命名為*ImageCapture*。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-404">Name the script *ImageCapture*.</span></span>

3.  <span data-ttu-id="7c0f3-405">按兩下新的**ImageCapture**腳本, 以**Visual Studio**開啟它。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-405">Double-click on the new **ImageCapture** script to open it with **Visual Studio**.</span></span>

4.  <span data-ttu-id="7c0f3-406">將檔案頂端的命名空間取代為下列內容:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-406">Replace the namespaces at the top of the file with the following:</span></span>
...
5.  <span data-ttu-id="7c0f3-407">然後, 在*ImageCapture*類別內的**Start ()** 方法上方新增下列變數:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-407">Then add the following variables inside the *ImageCapture* class, above the **Start()** method:</span></span>
...
6.  <span data-ttu-id="7c0f3-408">現在必須加入**喚醒 ()** 和**Start ()** 方法的程式碼:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-408">Code for **Awake()** and **Start()** methods now needs to be added:</span></span>
...
7.  <span data-ttu-id="7c0f3-409">執行會在點碰手勢發生時呼叫的處理常式。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-409">Implement a handler that will be called when a Tap gesture occurs.</span></span>
    ...
    > [!NOTE] 
    > <span data-ttu-id="7c0f3-410">在*分析*模式中, **TapHandler**方法會作為啟動或停止相片捕捉迴圈的交換器。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-410">In *Analysis* mode, the **TapHandler** method acts as a switch to start or stop the photo capture loop.</span></span>
    >
    > <span data-ttu-id="7c0f3-411">在*定型*模式中, 它會從相機捕捉影像。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-411">In *Training* mode, it will capture an image from the camera.</span></span>
    >
    > <span data-ttu-id="7c0f3-412">當游標呈綠色時, 表示相機可以取得影像。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-412">When the cursor is green, it means the camera is available to take the image.</span></span>
    >
    > <span data-ttu-id="7c0f3-413">當游標為紅色時, 表示相機忙碌中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-413">When the cursor is red, it means the camera is busy.</span></span>

8.  <span data-ttu-id="7c0f3-414">新增應用程式用來啟動映射捕獲進程並儲存映射的方法。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-414">Add the method that the application uses to start the image capture process and store the image.</span></span>
...
9.  <span data-ttu-id="7c0f3-415">新增將在拍攝相片時呼叫的處理常式, 以及準備進行分析的時間。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-415">Add the handlers that will be called when the photo has been captured and for when it is ready to be analyzed.</span></span> <span data-ttu-id="7c0f3-416">然後會根據程式碼的設定模式, 將結果傳遞至*CustomVisionAnalyser*或*CustomVisionTrainer* 。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-416">The result is then passed to the *CustomVisionAnalyser* or the *CustomVisionTrainer* depending on which mode the code is set on.</span></span>
...
10. <span data-ttu-id="7c0f3-417">請務必先將您的變更儲存在**Visual Studio**中, 然後再返回**Unity**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-417">Be sure to save your changes in **Visual Studio** before returning to **Unity**.</span></span>

11. <span data-ttu-id="7c0f3-418">既然所有腳本都已完成, 請回到 Unity 編輯器, 然後按一下 [**腳本**] 資料夾中的 [ **SceneOrganiser** ] 類別, 並將其拖曳至 [階層]*面板*中的**主要相機**物件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-418">Now that all the scripts have been completed, go back in the Unity Editor, then click and drag the **SceneOrganiser** class from the **Scripts** folder to the **Main Camera** object in the *Hierarchy Panel*.</span></span>

## <a name="chapter-12---before-building"></a><span data-ttu-id="7c0f3-419">第12章-建立前</span><span class="sxs-lookup"><span data-stu-id="7c0f3-419">Chapter 12 - Before building</span></span>

<span data-ttu-id="7c0f3-420">若要執行應用程式的徹底測試, 您必須將它側載到 HoloLens。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-420">To perform a thorough test of your application you will need to sideload it onto your HoloLens.</span></span>

<span data-ttu-id="7c0f3-421">在您執行之前, 請確定:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-421">Before you do, ensure that:</span></span>

- <span data-ttu-id="7c0f3-422">[第2章](#chapter-2---training-your-custom-vision-project)所述的所有設定都已正確設定。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-422">All the settings mentioned in the [Chapter 2](#chapter-2---training-your-custom-vision-project) are set correctly.</span></span>

- <span data-ttu-id="7c0f3-423">**主相機**中的所有欄位 [Inspector] 面板都會適當地指派。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-423">All the fields in the **Main Camera**, Inspector Panel, are assigned properly.</span></span>

- <span data-ttu-id="7c0f3-424">腳本**SceneOrganiser**會附加到**主要相機**物件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-424">The script **SceneOrganiser** is attached to the **Main Camera** object.</span></span>

- <span data-ttu-id="7c0f3-425">請務必將您的**預測金鑰**插入**predictionKey**變數中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-425">Make sure you insert your **Prediction Key** into the **predictionKey** variable.</span></span>

- <span data-ttu-id="7c0f3-426">您已將**預測端點**插入**predictionEndpoint**變數中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-426">You have inserted your **Prediction Endpoint** into the **predictionEndpoint** variable.</span></span>

- <span data-ttu-id="7c0f3-427">您已將**定型金鑰**插入*CustomVisionTrainer*類別的**trainingKey**變數中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-427">You have inserted your **Training Key** into the **trainingKey** variable, of the *CustomVisionTrainer* class.</span></span>

- <span data-ttu-id="7c0f3-428">您已將**專案識別碼**插入*CustomVisionTrainer*類別的**projectId**變數中。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-428">You have inserted your **Project ID** into the **projectId** variable, of the *CustomVisionTrainer* class.</span></span>

## <a name="chapter-13---build-and-sideload-your-application"></a><span data-ttu-id="7c0f3-429">第13章-組建和側載您的應用程式</span><span class="sxs-lookup"><span data-stu-id="7c0f3-429">Chapter 13 - Build and sideload your application</span></span>

<span data-ttu-id="7c0f3-430">若要開始*建立*程式:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-430">To begin the *Build* process:</span></span>

1.  <span data-ttu-id="7c0f3-431">移至 [檔案] **> [組建設定**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-431">Go to **File > Build Settings**.</span></span>

2.  <span data-ttu-id="7c0f3-432">Tick **Unity C\#專案**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-432">Tick **Unity C\# Projects**.</span></span>

3.  <span data-ttu-id="7c0f3-433">按一下 [建置] 。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-433">Click **Build**.</span></span> <span data-ttu-id="7c0f3-434">Unity 將會啟動 [檔案**瀏覽器**] 視窗, 您必須在其中建立並選取要建立應用程式的資料夾。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-434">Unity will launch a **File Explorer** window, where you need to create and then select a folder to build the app into.</span></span> <span data-ttu-id="7c0f3-435">立即建立該資料夾, 並將它命名為**應用程式**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-435">Create that folder now, and name it **App**.</span></span> <span data-ttu-id="7c0f3-436">然後選取 [**應用程式**] 資料夾, 按一下 [**選取資料夾**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-436">Then with the **App** folder selected, click on **Select Folder**.</span></span>

4.  <span data-ttu-id="7c0f3-437">Unity 會開始將您的專案建立至**應用程式**資料夾。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-437">Unity will begin building your project to the **App** folder.</span></span>

5.  <span data-ttu-id="7c0f3-438">Unity 完成建立之後 (可能需要一些時間), 它會在組建的位置開啟 [檔案**瀏覽器**] 視窗 (請檢查您的工作列, 因為它不一定會出現在視窗的上方, 但會通知您加入新的視窗)。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-438">Once Unity has finished building (it might take some time), it will open a **File Explorer** window at the location of your build (check your task bar, as it may not always appear above your windows, but will notify you of the addition of a new window).</span></span>

<span data-ttu-id="7c0f3-439">若要在 HoloLens 上部署:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-439">To deploy on HoloLens:</span></span>

1.  <span data-ttu-id="7c0f3-440">您將需要 HoloLens 的 IP 位址 (用於遠端部署), 並確保 HoloLens 處於**開發人員模式**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-440">You will need the IP Address of your HoloLens (for Remote Deploy), and to ensure your HoloLens is in **Developer Mode**.</span></span> <span data-ttu-id="7c0f3-441">請這樣做：</span><span class="sxs-lookup"><span data-stu-id="7c0f3-441">To do this:</span></span>

    1.  <span data-ttu-id="7c0f3-442">在戴 HoloLens 的同時, 請開啟**設定**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-442">Whilst wearing your HoloLens, open the **Settings**.</span></span>

    2.  <span data-ttu-id="7c0f3-443">前往**Network & Internet**  >  **wi-fi**  >  **Advanced Options**</span><span class="sxs-lookup"><span data-stu-id="7c0f3-443">Go to **Network & Internet** > **Wi-Fi** > **Advanced Options**</span></span>

    3.  <span data-ttu-id="7c0f3-444">記下**IPv4**位址。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-444">Note the **IPv4** address.</span></span>

    4.  <span data-ttu-id="7c0f3-445">接下來, 流覽回到 [**設定**], 然後為**開發人員** **更新 & 安全性** > </span><span class="sxs-lookup"><span data-stu-id="7c0f3-445">Next, navigate back to **Settings**, and then to **Update & Security** > **For Developers**</span></span>

    5.  <span data-ttu-id="7c0f3-446">將**開發人員模式**設定為 On。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-446">Set **Developer Mode On**.</span></span>

2.  <span data-ttu-id="7c0f3-447">流覽至新的 Unity 組建 (**應用程式**資料夾), 然後使用**Visual Studio**開啟方案檔。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-447">Navigate to your new Unity build (the **App** folder) and open the solution file with **Visual Studio**.</span></span>

3.  <span data-ttu-id="7c0f3-448">在 [*解決方案*設定] 中, 選取 [ **Debug**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-448">In the *Solution Configuration* select **Debug**.</span></span>

4.  <span data-ttu-id="7c0f3-449">在*解決方案平臺*中, 選取 [ **x86]、[遠端電腦**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-449">In the *Solution Platform*, select **x86, Remote Machine**.</span></span> <span data-ttu-id="7c0f3-450">系統會提示您插入遠端裝置的**IP 位址**(在此案例中, 這是您記下的 HoloLens)。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-450">You will be prompted to insert the **IP address** of a remote device (the HoloLens, in this case, which you noted).</span></span>

    ![](images/AzureLabs-Lab302b-34.png)

5. <span data-ttu-id="7c0f3-451">移至 [**建立**] 功能表, 然後按一下 [**部署方案**], 將應用程式側載至您的 HoloLens。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-451">Go to **Build** menu and click on **Deploy Solution** to sideload the application to your HoloLens.</span></span>

6. <span data-ttu-id="7c0f3-452">您的應用程式現在應該會出現在 HoloLens 上已安裝的應用程式清單中, 準備好啟動!</span><span class="sxs-lookup"><span data-stu-id="7c0f3-452">Your app should now appear in the list of installed apps on your HoloLens, ready to be launched!</span></span>

> [!NOTE]
> <span data-ttu-id="7c0f3-453">若要部署到沉浸式耳機, 請將**解決方案平臺**設定為 [*本機電腦*], 然後將 [設定] 設為 [  *Debug*], 並將*x86*作為**平臺**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-453">To deploy to immersive headset, set the **Solution Platform** to *Local Machine*, and set the **Configuration** to *Debug*, with *x86* as the **Platform**.</span></span> <span data-ttu-id="7c0f3-454">然後, 使用 [**建立**] 功能表項目選取 [*部署解決方案*], 部署至本機電腦。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-454">Then deploy to the local machine, using the **Build** menu item, selecting *Deploy Solution*.</span></span> 

## <a name="to-use-the-application"></a><span data-ttu-id="7c0f3-455">若要使用應用程式:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-455">To use the application:</span></span>

<span data-ttu-id="7c0f3-456">若要在*定型*模式和*預測*模式之間切換應用程式功能, 您必須更新位於*ImageCapture*類別內的**喚醒 ()** 方法中的**AppMode**變數。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-456">To switch the app functionality between *Training* mode and *Prediction* mode you need to update the **AppMode** variable, located in the **Awake()** method located within the *ImageCapture* class.</span></span>

```
        // Change this flag to switch between Analysis mode and Training mode 
        AppMode = AppModes.Training;
```
<span data-ttu-id="7c0f3-457">或</span><span class="sxs-lookup"><span data-stu-id="7c0f3-457">or</span></span>
```
        // Change this flag to switch between Analysis mode and Training mode 
        AppMode = AppModes.Analysis;
```

<span data-ttu-id="7c0f3-458">在*定型*模式中:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-458">In *Training* mode:</span></span>

- <span data-ttu-id="7c0f3-459">查看**滑鼠**或**鍵盤**, 並使用點按**手勢**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-459">Look at **Mouse** or **Keyboard** and use the **Tap gesture**.</span></span>

- <span data-ttu-id="7c0f3-460">接下來, 系統會顯示文字, 要求您提供標記。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-460">Next, text will appear asking you to provide a tag.</span></span>

- <span data-ttu-id="7c0f3-461">說是**滑鼠**或**鍵盤**。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-461">Say either **Mouse** or **Keyboard**.</span></span>


<span data-ttu-id="7c0f3-462">在*預測*模式中:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-462">In *Prediction* mode:</span></span>

- <span data-ttu-id="7c0f3-463">查看物件, 並使用 [點按**手勢**]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-463">Look at an object and use the **Tap gesture**.</span></span>

- <span data-ttu-id="7c0f3-464">系統會顯示文字, 提供偵測到的物件, 機率最高 (這是正規化的)。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-464">Text will appear providing the object detected, with the highest probability (this is normalized).</span></span>

## <a name="chapter-14---evaluate-and-improve-your-custom-vision-model"></a><span data-ttu-id="7c0f3-465">第14章-評估並改善您的自訂視覺模型</span><span class="sxs-lookup"><span data-stu-id="7c0f3-465">Chapter 14 - Evaluate and improve your Custom Vision model</span></span>

<span data-ttu-id="7c0f3-466">若要讓您的服務更精確, 您必須繼續定型用於預測的模型。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-466">To make your Service more accurate, you will need to continue to train the model used for prediction.</span></span> <span data-ttu-id="7c0f3-467">這是透過使用您的新應用程式來完成, 同時包含*定型*和*預測*模式, 後者則需要您造訪入口網站, 這是本章所涵蓋的內容。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-467">This is accomplished through using your new application, with both the *training* and *prediction* modes, with the latter requiring you to visit the portal, which is what is covered in this Chapter.</span></span> <span data-ttu-id="7c0f3-468">準備好重新流覽您的入口網站許多次, 以持續改善您的模型。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-468">Be prepared to revisit your portal many times, to continually improve your model.</span></span>

1. <span data-ttu-id="7c0f3-469">再次前往您的 Azure 自訂視覺入口網站, 然後在您的專案中, 選取 [*預測*] 索引標籤 (位於頁面的頂端中央):</span><span class="sxs-lookup"><span data-stu-id="7c0f3-469">Head to your Azure Custom Vision Portal again, and once you are in your project, select the *Predictions* tab (from the top center of the page):</span></span>

    ![](images/AzureLabs-Lab302b-35.png)

2. <span data-ttu-id="7c0f3-470">當您的應用程式正在執行時, 您會看到所有已傳送至服務的映射。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-470">You will see all the images which were sent to your Service whilst your application was running.</span></span> <span data-ttu-id="7c0f3-471">如果您將滑鼠停留在影像上, 則會為您提供針對該影像所做的預測:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-471">If you hover over the images, they will provide you with the predictions that were made for that image:</span></span>

    ![](images/AzureLabs-Lab302b-36.png)

3. <span data-ttu-id="7c0f3-472">選取其中一個影像來加以開啟。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-472">Select one of your images to open it.</span></span> <span data-ttu-id="7c0f3-473">開啟之後, 您將會看到對該影像所做的預測。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-473">Once open, you will see the predictions made for that image to the right.</span></span> <span data-ttu-id="7c0f3-474">如果您的預測正確, 而您想要將此影像新增至服務的定型模型, 請按一下 [*我的標記*] 輸入方塊, 然後選取要建立關聯的標籤。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-474">If you the predictions were correct, and you wish to add this image to your Service's training model, click the *My Tags* input box, and select the tag you wish to associate.</span></span> <span data-ttu-id="7c0f3-475">當您完成時, 請按一下右下方的 [*儲存並關閉*] 按鈕, 然後繼續進行下一個影像。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-475">When you are finished, click the *Save and close* button to the bottom right, and continue on to the next image.</span></span>

    ![](images/AzureLabs-Lab302b-37.png)

4. <span data-ttu-id="7c0f3-476">當您回到影像的方格後, 您會注意到您已新增標記的影像 (並儲存) 將會被移除。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-476">Once you are back to the grid of images, you will notice the images which you have added tags to (and saved), will be removed.</span></span> <span data-ttu-id="7c0f3-477">如果您發現任何您認為沒有標記專案的影像, 可以將其刪除, 方法是按一下該影像上的刻度 (可以針對數個影像執行此動作), 然後按一下格線頁右上角的 [*刪除*]。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-477">If you find any images which you think do not have your tagged item within them, you can delete them, by clicking the tick on that image (can do this for several images) and then clicking *Delete* in the upper right corner of the grid page.</span></span> <span data-ttu-id="7c0f3-478">在接下來的快顯視窗中, 您可以按一下 *[是]、[刪除] 或 [* *否*], 分別確認刪除或取消。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-478">On the popup that follows, you can click either *Yes, delete* or *No*, to confirm the deletion or cancel it, respectively.</span></span> 

    ![](images/AzureLabs-Lab302b-38.png)

5. <span data-ttu-id="7c0f3-479">當您準備好繼續進行時, 請按一下右上方的綠色 [*訓練*] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-479">When you are ready to proceed, click the green *Train* button in the top right.</span></span> <span data-ttu-id="7c0f3-480">您的服務模型將會使用您現在提供的所有影像 (這會使其更精確) 進行定型。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-480">Your Service model will be trained with all the images which you have now provided (which will make it more accurate).</span></span> <span data-ttu-id="7c0f3-481">定型完成之後, 請務必按一下 [*設為預設值*] 按鈕, 讓您的*預測 URL*繼續使用服務的最新反復專案。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-481">Once the training is complete, make sure to click the *Make default* button once more, so that your *Prediction URL* continues to use the most up-to-date iteration of your Service.</span></span>

    <span data-ttu-id="7c0f3-482">![](images/AzureLabs-Lab302b-39.png) ![](images/AzureLabs-Lab302b-40.png)</span><span class="sxs-lookup"><span data-stu-id="7c0f3-482">![](images/AzureLabs-Lab302b-39.png) ![](images/AzureLabs-Lab302b-40.png)</span></span>

## <a name="your-finished-custom-vision-api-application"></a><span data-ttu-id="7c0f3-483">您完成的自訂視覺 API 應用程式</span><span class="sxs-lookup"><span data-stu-id="7c0f3-483">Your finished Custom Vision API application</span></span>

<span data-ttu-id="7c0f3-484">恭喜您, 您建立了一個混合現實應用程式, 利用 Azure 自訂視覺 API 來辨識現實世界的物件、訓練服務模型, 以及顯示已看到的內容。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-484">Congratulations, you built a mixed reality app that leverages the Azure Custom Vision API to recognize real world objects, train the Service model, and display confidence of what has been seen.</span></span>

![](images/AzureLabs-Lab302b-00.png)

## <a name="bonus-exercises"></a><span data-ttu-id="7c0f3-485">額外練習</span><span class="sxs-lookup"><span data-stu-id="7c0f3-485">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="7c0f3-486">練習1</span><span class="sxs-lookup"><span data-stu-id="7c0f3-486">Exercise 1</span></span>

<span data-ttu-id="7c0f3-487">訓練您的**自訂視覺服務**, 以辨識更多物件。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-487">Train your **Custom Vision Service** to recognize more objects.</span></span>

### <a name="exercise-2"></a><span data-ttu-id="7c0f3-488">練習2</span><span class="sxs-lookup"><span data-stu-id="7c0f3-488">Exercise 2</span></span>

<span data-ttu-id="7c0f3-489">若要展開您所學到的內容, 請完成下列練習:</span><span class="sxs-lookup"><span data-stu-id="7c0f3-489">As a way to expand on what you have learned, complete the following exercises:</span></span>

<span data-ttu-id="7c0f3-490">在辨識物件時播放音效。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-490">Play a sound when an object is recognized.</span></span>

### <a name="exercise-3"></a><span data-ttu-id="7c0f3-491">練習3</span><span class="sxs-lookup"><span data-stu-id="7c0f3-491">Exercise 3</span></span>

<span data-ttu-id="7c0f3-492">使用 API, 以應用程式所分析的相同影像重新訓練您的服務, 以便讓服務更精確 (同時進行預測和定型)。</span><span class="sxs-lookup"><span data-stu-id="7c0f3-492">Use the API to re-train your Service with the same images your app is analyzing, so to make the Service more accurate (do both prediction and training simultaneously).</span></span>
