...
3.  從左邊的展開面板 **儲存的資料集*> * 我的資料集 * * 和拖曳**ProductsTableCSV**入**實驗畫布**。
...
7.  在 **實驗**左側面板中，展開 **Machine Learning* > * 訓練 **。拖曳 **定型模型 」 中的項目出到實驗畫布。 畫布看起來應該與相同如下。
...
12. 從 實驗 項目面板的 在左側，展開 * **Machine Learning* > *初始化模型*> * 分類 ***，然後將拖曳 **多級羅吉斯迴歸 * * 項目至實驗畫布。

13. 輸出中，連接到從底部**多級羅吉斯迴歸**的左上方輸入**定型模型**項目。

    ![Machine Learning Studio:實驗](images/AzureLabs-Lab7-23.png)

14. 在清單中的實驗項目，在左側面板中，展開 **Machine Learning* > * 分數 **，然後將拖曳 **分數模型 項目至畫布。
...
17. 在清單中**實驗**的左側面板中的項目會展開 * **Machine Learning* > * 評估 ***，並拖曳 **評估模型 項目拖曳至畫布。
